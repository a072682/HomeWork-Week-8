...
export const countSlice = createSlice({ // todoSlice可任意取名
    name:"count", //此名稱為連接main.jsx的名稱
    initialState:{  //初始資料狀態
       data:[
       	 {
           	 	title:"1"
...
export const {updataCount} = countSlice.actions; // updataTodo需要在此引出這樣外部檔案才可以利用
...
//         }
// )
export default countSlice.reducer; // 和todoSlice名稱需要相同
